...
module.exports = {
  ...
  head: [
    ...
    ['meta', { property: 'og:url', content: 'https://erc20bep20.github.io/watch-token' }],
    ['meta', { property: 'og:image', content: 'https://erc20bep20.github.io/watch-token/assets/images/watch-token.jpg' }], // eslint-disable-line max-len
    ['meta', { property: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { property: 'twitter:image', content: 'https://erc20bep20.github.io/watch-token/assets/images/watch-token.jpg' }], // eslint-disable-line max-len
    ['meta', { property: 'twitter:title', content: 'WatchToken | Create a Widget for your ERC20 or BEP20 Token' }],
    ['script', { src: '/assets/js/web3.min.js' }],
    ['script',
      {
        src: '', // eslint-disable-line max-len
        defer: true,
      },
    ],
  ],
