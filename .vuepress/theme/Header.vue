  ...
  <b-navbar toggleable="md" variant="light">
    ...
    <b-collapse is-nav id="nav_collapse">
      ...
      <b-navbar-nav class="ml-auto">
        <b-nav-item target="_blank" href="https://erc20bep20.github.io/erc20-generator/">
          <b-badge class="p-2" variant="info">Create ERC20 Token</b-badge>
        </b-nav-item>
        <b-nav-item target="_blank" href="https://erc20bep20.github.io/bep20-generator/">
          <b-badge class="p-2" variant="warning">Create BEP20 Token</b-badge>
        </b-nav-item>
        <b-nav-item target="_blank" href="https://erc20bep20.medium.com/how-to-add-token-to-metamask-fba11854f6cd">
          <small>About</small>
        </b-nav-item>
      </b-navbar-nav>
    </b-collapse>
